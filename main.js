...
// console.log(randomPropValueValue);
...
//     if(e.target.className === "span-box"){

//         e.target.classList.add("clicked") 

//         let theClickedLetter = e.target.innerHTML.toLowerCase();

//         let theChoseWord = Array.from(randomPropValueValue.toLowerCase());
